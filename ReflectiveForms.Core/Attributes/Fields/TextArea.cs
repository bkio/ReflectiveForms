...
public sealed class TextArea : Field
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            element.DefaultValue = nullableCurrentValueJToken.Value<string>().NotNull().Replace("\r\n", "\n").Replace("\n", "\r\n");
        }
        else if (_defaultValueNullable != null)
        {
            element.DefaultValue = _defaultValueNullable.Replace("\r\n", "\n").Replace("\n", "\r\n");
        }
        else
        {
